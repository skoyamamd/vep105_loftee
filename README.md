...
First enter your github username and token (https://github.com/settings/tokens) to docker: `docker login ghcr.io`
...
Pull docker image built from the Dockerfile in this repo and convert to a singularity.sif. You will need to provide your github username and token (https://github.com/settings/tokens) as a password.
```
